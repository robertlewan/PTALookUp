...
import type { CustomPassive } from '../types/models';

export default function AddCustomPassiveScreen() {
  const navigation = useNavigation<any>();
  const route = useRoute<any>();
  const onAdd: (passive: CustomPassive) => void | Promise<void> = route.params.onAdd;
